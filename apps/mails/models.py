...
class MailTemplate(models.Model):
    ...
    text_template = models.TextField(
        ...
        help_text=_(
            "This is an optional field for adding a custom text-only version of this template. If left blank, the plaintext email will be generated dynamically from the HTML when needed."),
        default="",
        null=True,
        blank=True,
    )
