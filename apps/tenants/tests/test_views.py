...
class TenantDomainTests(TestCase):
    ...
    def setUp(self):
        ...
        self.site = Site.objects.create(name=f"a.{self.tenant_domain}", domain=f"a.{self.tenant_domain}")
        self.tenant = Tenant.objects.create(name="A", site=self.site)
        self.domain = Domain.objects.create(domain="a.com", tenant=self.tenant)

        self.other_site = Site.objects.create(name=f"other.{self.tenant_domain}", domain=f"other.{self.tenant_domain}")
        ...
        self.site_not_linked = Site.objects.create(name=f"notlinked.{self.tenant_domain}",
                                                   domain=f"notlinked.{self.tenant_domain}")
    ...
    def test_tenant_root_domain_should_be_accessible(self):
        ...
        response = self.client.get(self.home_url, HTTP_HOST=self.tenant_domain)
    ...
    def test_tenant_secret_page_on_root_domain_should_not_be_accessible(self):
        ...
        response = self.client.get(self.secret_url, HTTP_HOST=self.tenant_domain)
